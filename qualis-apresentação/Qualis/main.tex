...
\usepackage{rotating} % permite rotacionar textos e figuras -> como na tabela cronograma
\usepackage{xcolor,colortbl} % colorir células de tabelas
\input{config}
...
\titlegraphic{\includegraphics[width=0.7\textwidth]{figuras/fomento1.pdf}}
...
\input{seções/blockchain}
\input{seções/contratos-inteligentes}
\input{seções/verificacao}
\input{seções/metodologia}
\input{seções/proposta}
